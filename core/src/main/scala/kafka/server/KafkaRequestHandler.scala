 ...
 */
class KafkaRequestHandler(id: Int,  // I/O线程的序号
                          brokerId: Int, // broker.id的值
                          val aggregateIdleMeter: Meter,
                          val totalHandlerThreads: AtomicInteger, // I/O线程池大小
                          val requestChannel: RequestChannel, // 请求处理通道
                          apis: ApiRequestHandler, // ApiRequestHandler,真正用于请求处理逻辑的类
...
class KafkaRequestHandlerPool(val brokerId: Int, // broker.id
                              val requestChannel: RequestChannel, // SocketServer组件下的RequestChannel对象
                              val apis: ApiRequestHandler, // 实际的请求处理类
                              time: Time,
                              numThreads: Int, // I/O线程池的初始大小
